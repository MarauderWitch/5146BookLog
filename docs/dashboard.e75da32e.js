 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cG{constructor(e){this.apiKey=e}getGenerativeModel(e,t){if(!e.model)throw new cm("Must provide a model name. Example: genai.getGenerativeModel({ model: 'my-model-name' })");return new cK(this.apiKey,e,t)}getGenerativeModelFromCachedContent(e,t,n){if(!e.name)throw new cw("Cached content must contain a `name` field.");if(!e.model)throw new cw("Cached content must contain a `model` field.");for(let n of["model","systemInstruction"])if((null==t?void 0:t[n])&&e[n]&&(null==t?void 0:t[n])!==e[n]){if("model"===n&&(t.model.startsWith("models/")?t.model.replace("models/",""):t.model)===(e.model.startsWith("models/")?e.model.replace("models/",""):e.model))continue;throw new cw(`Different value for "${n}" specified in modelParams (${t[n]}) and cachedContent (${e[n]})`)}let r=Object.assign(Object.assign({},t),{model:e.model,tools:e.tools,toolConfig:e.toolConfig,systemInstruction:e.systemInstruction,cachedContent:e});return new cK(this.apiKey,r,n)}}o(cp).setLevel("info"),o(cp).info("Application started"),console.log("Database:",r),console.log("Firebase Firestore:",i);const cW=new u4;document.getElementById("signIn").addEventListener("click",function(e){hB(i,cW).then(e=>{u4.credentialFromResult(e).accessToken;let t=e.user;localStorage.setItem("email",JSON.stringify(t.email)),window.location="dashboard.html"}).catch(e=>{e.code,e.message,e.customData.email,u4.credentialFromError(e)})});const cQ=localStorage.getItem("email")?JSON.parse(localStorage.getItem("email")):null;if(console.log("Email:",cQ),cQ||(console.warn("No email found. Redirecting to login page..."),setTimeout(()=>{window.location.href="index.html"},1e3)),document.getElementById("logout").addEventListener("click",function(e){localStorage.removeItem("email"),window.location.href="index.html"}),console.log("Checking for book-form:",document.getElementById("book-form")),document.getElementById("book-form")){console.log("Initializing Book Logic..."),document.getElementById("book-form");let e=document.getElementById("book-list");async function cY(e,t,n,s){try{let o=i.currentUser;if(!o){console.error("No user signed in. Cannot add book.");return}await function(e,t){var n;let r=a$(e.firestore,aZ),i=aY(e),s=(n=e.converter)?n.toFirestore(t):t;return lC(r,[(function(e,t,n,r,i,s={}){let o,a;let l=e.ju(s.merge||s.mergeFields?2:0,t,n,i);ls("Data must be an object, but it was:",l,r);let u=lr(r,l);if(s.merge)o=new n7(l.fieldMask),a=l.fieldTransforms;else if(s.mergeFields){let e=[];for(let r of s.mergeFields){let i=function(e,t,n){if((t=eq(t))instanceof a2)return t._internalPath;if("string"==typeof t)return la(e,t);throw ll("Field path arguments must be of type string or ",e,!1,void 0,n)}(t,r,n);if(!l.contains(i))throw new nS(nC.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);(function(e,t){return e.some(e=>e.isEqual(t))})(e,i)||e.push(i)}o=new n7(e),a=l.fieldTransforms.filter(e=>o.covers(e.field))}else o=null,a=l.fieldTransforms;return new a4(new rM(u),o,a)})(lt(e.firestore),"addDoc",i._key,s,null!==e.converter,{}).toMutation(i._key,iD.exists(!1))]).then(()=>i)}(aQ(r,"books"),{title:e,author:t,genre:n,rating:s,email:o.email}),console.log(`Book "${e}" added successfully by ${o.email}.`),cJ()}catch(e){console.error("Error adding book:",e)}}async function cJ(){console.log("Fetching books...");try{let t=i.currentUser;if(!t){console.log("No user signed in. Cannot fetch books.");return}let n=function(e,t,...n){let r=[];for(let i of(t instanceof lf&&r.push(t),function(e){let t=e.filter(e=>e instanceof lg).length,n=e.filter(e=>e instanceof lp).length;if(t>1||t>0&&n>0)throw new nS(nC.INVALID_ARGUMENT,"InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.")}(r=r.concat(n)),r))e=i._apply(e);return e}(aQ(r,"books"),function(e,t,n){let r=lc("where",e);return lp._create(r,"==",n)}("email",0,t.email)),s=await function(e){e=a$(e,aK);let t=a$(e.firestore,aZ),n=a0(t),r=new lT(t);return(/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new nS(nC.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(e._query),(function(e,t,n={}){let r=new nA;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new ak({next:n=>{s.su(),t.enqueueAndForget(()=>o1(e,o)),n.fromCache&&"server"===r.source?i.reject(new nS(nC.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(n)},error:e=>i.reject(e)}),o=new o5(n,s,{includeMetadataChanges:!0,Ta:!0});return o0(e,o)})(await aL(e),e.asyncQueue,t,n,r)),r.promise})(n,e._query).then(n=>new lb(t,r,e,n)))}(n);if(s.empty){e.innerHTML="<p>No books added yet.</p>",console.log("No books found in database.");return}s.forEach(t=>{let n=t.data(),r=t.id,i=document.createElement("li");i.id=r,i.innerHTML=`
                    ...
                    `,e.appendChild(i)}),console.log("Books successfully displayed.")}catch(e){console.error("Error fetching and displaying books:",e)}}if(document.addEventListener("click",async e=>{if(e.target.classList.contains("delete-btn")){let n=e.target.getAttribute("data-id");try{var t;await (t=aY(r,"books",n),lC(a$(t.firestore,aZ),[new iH(t._key,iD.none())])),console.log(`Book with ID ${n} deleted.`),cJ()}catch(e){console.error("Error deleting book:",e)}}}),document.getElementById("book-form")){console.log("Book form found. Initializing book logic...");let e=document.getElementById("book-form");document.getElementById("book-list"),e.addEventListener("submit",function(t){console.log("Form submit event detected."),t.preventDefault(),console.log("Book form submitted.");let n=document.getElementById("title").value.trim(),r=document.getElementById("author").value.trim(),i=document.getElementById("genre").value.trim(),s=document.getElementById("rating").value.trim();if(!n||!r||!i||!s){console.error("All fields must be filled.");return}console.log("Form values:",{title:n,author:r,genre:i,rating:s}),cY(n,r,i,s),e.reset()}),cJ()}else console.error("Book form not found.")}const cX=document.getElementById("chat-input"),cZ=document.getElementById("send-btn"),c0=document.getElementById("chat-history");async function c1(){model=(genAI=new cG(apiKey=(await function(e){e=a$(e,aG);let t=a$(e.firestore,aZ);return(function(e,t,n={}){let r=new nA;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new ak({next:a=>{s.su(),t.enqueueAndForget(()=>o1(e,o));let l=a.docs.has(n);!l&&a.fromCache?i.reject(new nS(nC.UNAVAILABLE,"Failed to get document because the client is offline.")):l&&a.fromCache&&r&&"server"===r.source?i.reject(new nS(nC.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(a)},error:e=>i.reject(e)}),o=new o5(new r8(n.path),s,{includeMetadataChanges:!0,Ta:!0});return o0(e,o)})(await aL(e),e.asyncQueue,t,n,r)),r.promise})(a0(t),e._key).then(n=>(function(e,t,n){let r=n.docs.get(t._key),i=new lT(e);return new l_(e,i,t._key,r,new lE(n.hasPendingWrites,n.fromCache),t.converter)})(t,e,n))}(aY(r,"apikey","googlegenai"))).data().key)).getGenerativeModel({model:"gemini-1.5-flash"})}async function c2(e){return(await model.generateContent(e)).candidates[0].content.parts[0].text}function c6(e){let t=document.createElement("div");t.textContent=e,t.className="history",c0.appendChild(t)}cX&&cZ&&cZ.addEventListener("click",async()=>{let e=cX.value.trim();if(e){var t;if(c6(`You: ${e}`,"user"),!((t=(t=e).toLowerCase().trim()).startsWith("add")?(c6("To add a book, enter title, author, genre, and rating, then click 'Add Book'."),!0):t.startsWith("delete")?(c6("To delete a book, click the 'Delete' button next to it."),!0):(c6("I'm sorry, I didn't understand that command."),!1)))try{let t=await c2(e);c6(`Chatbot: ${t}`,"bot")}catch(e){console.error("Error with AI chatbot:",e),c6("Chatbot: Sorry, I couldn't process that request.","bot")}cX.value=""}}),!async function(){await c1(),console.log("AI initialized successfully.")}();
//# sourceMappingURL=dashboard.e75da32e.js.map
