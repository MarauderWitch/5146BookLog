 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class M extends Error{constructor(e){super(`[GoogleGenerativeAI Error]: ${e}`)}}class D extends M{constructor(e,t){super(e),this.response=t}}class L extends M{constructor(e,t,n,o){super(e),this.status=t,this.statusText=n,this.errorDetails=o}}class x extends M{}(u=_||(_={})).GENERATE_CONTENT="generateContent",u.STREAM_GENERATE_CONTENT="streamGenerateContent",u.COUNT_TOKENS="countTokens",u.EMBED_CONTENT="embedContent",u.BATCH_EMBED_CONTENTS="batchEmbedContents";class k{constructor(e,t,n,o,s){this.model=e,this.task=t,this.apiKey=n,this.stream=o,this.requestOptions=s}toString(){var e,t;let n=(null===(e=this.requestOptions)||void 0===e?void 0:e.apiVersion)||"v1beta",o=(null===(t=this.requestOptions)||void 0===t?void 0:t.baseUrl)||"https://generativelanguage.googleapis.com",s=`${o}/${n}/${this.model}:${this.task}`;return this.stream&&(s+="?alt=sse"),s}}async function F(e){var t;let n=new Headers;n.append("Content-Type","application/json"),n.append("x-goog-api-client",function(e){let t=[];return(null==e?void 0:e.apiClient)&&t.push(e.apiClient),t.push("genai-js/0.22.0"),t.join(" ")}(e.requestOptions)),n.append("x-goog-api-key",e.apiKey);let o=null===(t=e.requestOptions)||void 0===t?void 0:t.customHeaders;if(o){if(!(o instanceof Headers))try{o=new Headers(o)}catch(e){throw new x(`unable to convert customHeaders value ${JSON.stringify(o)} to Headers: ${e.message}`)}for(let[e,t]of o.entries()){if("x-goog-api-key"===e)throw new x(`Cannot set reserved header name ${e}`);if("x-goog-api-client"===e)throw new x(`Header name ${e} can only be set using the apiClient field`);n.append(e,t)}}return n}async function H(e,t,n,o,s,i){let a=new k(e,t,n,o,i);return{url:a.toString(),fetchOptions:Object.assign(Object.assign({},function(e){let t={};if((null==e?void 0:e.signal)!==void 0||(null==e?void 0:e.timeout)>=0){let n=new AbortController;(null==e?void 0:e.timeout)>=0&&setTimeout(()=>n.abort(),e.timeout),(null==e?void 0:e.signal)&&e.signal.addEventListener("abort",()=>{n.abort()}),t.signal=n.signal}return t}(i)),{method:"POST",headers:await F(a),body:s})}}async function U(e,t,n,o,s,i={},a=fetch){let{url:r,fetchOptions:l}=await H(e,t,n,o,s,i);return B(r,l,a)}async function B(e,t,n=fetch){let o;try{o=await n(e,t)}catch(t){!function(e,t){let n=e;throw e instanceof L||e instanceof x||((n=new M(`Error fetching from ${t.toString()}: ${e.message}`)).stack=e.stack),n}(t,e)}return o.ok||await P(o,e),o}async function P(e,t){let n,o="";try{let t=await e.json();o=t.error.message,t.error.details&&(o+=` ${JSON.stringify(t.error.details)}`,n=t.error.details)}catch(e){}throw new L(`Error fetching from ${t.toString()}: [${e.status} ${e.statusText}] ${o}`,e.status,e.statusText,n)}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $(e){return e.text=()=>{if(e.candidates&&e.candidates.length>0){if(e.candidates.length>1&&console.warn(`This response had ${e.candidates.length} candidates. Returning text from the first candidate only. Access response.candidates directly to use the other candidates.`),K(e.candidates[0]))throw new D(`${Y(e)}`,e);return function(e){var t,n,o,s;let i=[];if(null===(n=null===(t=e.candidates)||void 0===t?void 0:t[0].content)||void 0===n?void 0:n.parts)for(let t of null===(s=null===(o=e.candidates)||void 0===o?void 0:o[0].content)||void 0===s?void 0:s.parts)t.text&&i.push(t.text),t.executableCode&&i.push("\n```"+t.executableCode.language+"\n"+t.executableCode.code+"\n```\n"),t.codeExecutionResult&&i.push("\n```\n"+t.codeExecutionResult.output+"\n```\n");return i.length>0?i.join(""):""}(e)}if(e.promptFeedback)throw new D(`Text not available. ${Y(e)}`,e);return""},e.functionCall=()=>{if(e.candidates&&e.candidates.length>0){if(e.candidates.length>1&&console.warn(`This response had ${e.candidates.length} candidates. Returning function calls from the first candidate only. Access response.candidates directly to use the other candidates.`),K(e.candidates[0]))throw new D(`${Y(e)}`,e);return console.warn("response.functionCall() is deprecated. Use response.functionCalls() instead."),G(e)[0]}if(e.promptFeedback)throw new D(`Function call not available. ${Y(e)}`,e)},e.functionCalls=()=>{if(e.candidates&&e.candidates.length>0){if(e.candidates.length>1&&console.warn(`This response had ${e.candidates.length} candidates. Returning function calls from the first candidate only. Access response.candidates directly to use the other candidates.`),K(e.candidates[0]))throw new D(`${Y(e)}`,e);return G(e)}if(e.promptFeedback)throw new D(`Function call not available. ${Y(e)}`,e)},e}function G(e){var t,n,o,s;let i=[];if(null===(n=null===(t=e.candidates)||void 0===t?void 0:t[0].content)||void 0===n?void 0:n.parts)for(let t of null===(s=null===(o=e.candidates)||void 0===o?void 0:o[0].content)||void 0===s?void 0:s.parts)t.functionCall&&i.push(t.functionCall);return i.length>0?i:void 0}const j=[y.RECITATION,y.SAFETY,y.LANGUAGE];function K(e){return!!e.finishReason&&j.includes(e.finishReason)}function Y(e){var t,n,o;let s="";if((!e.candidates||0===e.candidates.length)&&e.promptFeedback)s+="Response was blocked",(null===(t=e.promptFeedback)||void 0===t?void 0:t.blockReason)&&(s+=` due to ${e.promptFeedback.blockReason}`),(null===(n=e.promptFeedback)||void 0===n?void 0:n.blockReasonMessage)&&(s+=`: ${e.promptFeedback.blockReasonMessage}`);else if(null===(o=e.candidates)||void 0===o?void 0:o[0]){let t=e.candidates[0];K(t)&&(s+=`Candidate was blocked due to ${t.finishReason}`,t.finishMessage&&(s+=`: ${t.finishMessage}`))}return s}function q(e){return this instanceof q?(this.v=e,this):new q(e)}"function"==typeof SuppressedError&&SuppressedError;/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function z(e){if(null!=e){if("string"==typeof e)return{role:"system",parts:[{text:e}]};if(e.text)return{role:"system",parts:[e]};if(e.parts)return e.role?e:{role:"system",parts:e.parts}}}function Q(e){let t=[];if("string"==typeof e)t=[{text:e}];else for(let n of e)"string"==typeof n?t.push({text:n}):t.push(n);return function(e){let t={role:"user",parts:[]},n={role:"function",parts:[]},o=!1,s=!1;for(let i of e)"functionResponse"in i?(n.parts.push(i),s=!0):(t.parts.push(i),o=!0);if(o&&s)throw new M("Within a single message, FunctionResponse cannot be mixed with other type of part in the request for sending chat message.");if(!o&&!s)throw new M("No content is provided for sending chat message.");return o?t:n}(t)}function Z(e){let t;return t=e.contents?e:{contents:[Q(e)]},e.systemInstruction&&(t.systemInstruction=z(e.systemInstruction)),t}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class el{constructor(e){this.apiKey=e}getGenerativeModel(e,t){if(!e.model)throw new M("Must provide a model name. Example: genai.getGenerativeModel({ model: 'my-model-name' })");return new er(this.apiKey,e,t)}getGenerativeModelFromCachedContent(e,t,n){if(!e.name)throw new x("Cached content must contain a `name` field.");if(!e.model)throw new x("Cached content must contain a `model` field.");for(let n of["model","systemInstruction"])if((null==t?void 0:t[n])&&e[n]&&(null==t?void 0:t[n])!==e[n]){if("model"===n&&(t.model.startsWith("models/")?t.model.replace("models/",""):t.model)===(e.model.startsWith("models/")?e.model.replace("models/",""):e.model))continue;throw new x(`Different value for "${n}" specified in modelParams (${t[n]}) and cachedContent (${e[n]})`)}let o=Object.assign(Object.assign({},t),{model:e.model,tools:e.tools,toolConfig:e.toolConfig,systemInstruction:e.systemInstruction,cachedContent:e});return new er(this.apiKey,o,n)}}var ec=b("ilpIi");document.addEventListener("DOMContentLoaded",()=>{console.log("DOM fully loaded. Initializing app...");let e=document.getElementById("signIn");if(e){let t=new S.GoogleAuthProvider;e.addEventListener("click",()=>{(0,S.signInWithPopup)(R.auth,t).then(e=>{(0,S.GoogleAuthProvider).credentialFromResult(e).accessToken;let t=e.user;localStorage.setItem("email",JSON.stringify(t.email)),window.location="dashboard.html"}).catch(e=>{e.code,e.message,e.customData.email,(0,S.GoogleAuthProvider).credentialFromError(e),console.error(`Sign-in error [${e.code}]: ${e.message}`),alert(`Google Sign-In Error: ${e.message}`)})})}else console.warn("⚠ signIn button not found in the DOM.");let t=document.getElementById("logout");if(t&&t.addEventListener("click",()=>{(0,R.auth).signOut().then(()=>{console.log("User signed out."),localStorage.removeItem("email"),window.location.href="index.html"}).catch(e=>{console.error("Logout error:",e)})}),document.getElementById("book-form")){console.log("Initializing Book Logic...");let e=document.getElementById("book-form"),t=document.getElementById("book-list");async function n(e,t,n,s){try{await (0,ec.addDoc)((0,ec.collection)(R.db,"books"),{title:e,author:t,genre:n,rating:s}),console.log("Book added successfully."),o()}catch(e){console.error("Error adding book:",e)}}async function o(){try{console.log("Fetching books...");let e=await (0,ec.getDocs)((0,ec.collection)(R.db,"books"));if(e.empty){t.innerHTML="<p>No books added yet.</p>",console.log("⚠ No books in database.");return}e.forEach(e=>{let n=e.data(),o=e.id;console.log("Found book:",n),function(e,n){let o=document.createElement("li");o.innerHTML=`
                <strong>${e.title}</strong> by ${e.author} <em>(${e.genre})</em> - Rating: ${e.rating}
                <button onclick="deleteBook('${n}')">Delete</button>
            `,t.appendChild(o)}(n,o)}),console.log("Books successfully fetched.")}catch(e){console.error("Error fetching books:",e)}}e.addEventListener("submit",function(t){t.preventDefault();let o=document.getElementById("title").value,s=document.getElementById("author").value;n(o,s,document.getElementById("genre").value,document.getElementById("rating").value),e.reset()}),o()}let s=document.getElementById("chat-input"),i=document.getElementById("send-btn"),a=document.getElementById("chat-history");async function r(){model=(genAI=new el(apiKey=(await getDoc((0,ec.doc)(R.db,"apikey","googlegenai"))).data().key)).getGenerativeModel({model:"gemini-1.5-flash"})}async function l(e){return(await model.generateContent(e)).candidates[0].content.parts[0].text}function c(e){let t=document.createElement("div");t.textContent=e,t.className="history",a.appendChild(t)}s&&i&&i.addEventListener("click",async()=>{let e=s.value.trim();if(e){var t;if(c(`You: ${e}`,"user"),!((t=(t=e).toLowerCase().trim()).startsWith("add")?(c("To add a book, enter title, author, genre, and rating, then click 'Add Book'."),!0):t.startsWith("delete")?(c("To delete a book, click the 'Delete' button next to it."),!0):(c("I'm sorry, I didn't understand that command."),!1)))try{let t=await l(e);c(`Chatbot: ${t}`,"bot")}catch(e){console.error("Error with AI chatbot:",e),c("Chatbot: Sorry, I couldn't process that request.","bot")}s.value=""}}),!async function(){await r(),console.log("AI initialized successfully.")}()});
//# sourceMappingURL=dashboard.e21cc737.js.map
