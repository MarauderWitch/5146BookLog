 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cG{constructor(e){this.apiKey=e}getGenerativeModel(e,t){if(!e.model)throw new cm("Must provide a model name. Example: genai.getGenerativeModel({ model: 'my-model-name' })");return new cK(this.apiKey,e,t)}getGenerativeModelFromCachedContent(e,t,n){if(!e.name)throw new cw("Cached content must contain a `name` field.");if(!e.model)throw new cw("Cached content must contain a `model` field.");for(let n of["model","systemInstruction"])if((null==t?void 0:t[n])&&e[n]&&(null==t?void 0:t[n])!==e[n]){if("model"===n&&(t.model.startsWith("models/")?t.model.replace("models/",""):t.model)===(e.model.startsWith("models/")?e.model.replace("models/",""):e.model))continue;throw new cw(`Different value for "${n}" specified in modelParams (${t[n]}) and cachedContent (${e[n]})`)}let r=Object.assign(Object.assign({},t),{model:e.model,tools:e.tools,toolConfig:e.toolConfig,systemInstruction:e.systemInstruction,cachedContent:e});return new cK(this.apiKey,r,n)}}document.addEventListener("DOMContentLoaded",function(){o(cp).setLevel("info"),o(cp).info("Application started"),console.log("Firebase Firestore:",r,i);let e=new u4,t=document.getElementById("signIn");t?t.addEventListener("click",function(t){hB(i,e).then(e=>{u4.credentialFromResult(e).accessToken;let t=e.user;localStorage.setItem("email",JSON.stringify(t.email)),window.location="dashboard.html"}).catch(e=>{e.code,e.message,e.customData.email,u4.credentialFromError(e)})}):console.error("Sign-in button not found.");let n=localStorage.getItem("email")?JSON.parse(localStorage.getItem("email")):null;console.log("Email:",n),n||(console.warn("No email found. Redirecting to login page..."),setTimeout(()=>{window.location.href="index.html"},1e3));let s=document.getElementById("logout");if(s?s.addEventListener("click",function(e){localStorage.removeItem("email"),window.location.href="index.html"}):console.error("Logout button not found."),console.log("Checking for book-form:",document.getElementById("book-form")),document.getElementById("book-form")){console.log("Initializing Book Logic..."),document.getElementById("book-form");let e=document.getElementById("book-list");async function a(e,t,n,s){i.onAuthStateChanged(async i=>{if(!i){console.error("No user signed in. Cannot add book.");return}try{await function(e,t){var n;let r=a$(e.firestore,aZ),i=aY(e),s=(n=e.converter)?n.toFirestore(t):t;return lC(r,[(function(e,t,n,r,i,s={}){let o,a;let l=e.ju(s.merge||s.mergeFields?2:0,t,n,i);ls("Data must be an object, but it was:",l,r);let u=lr(r,l);if(s.merge)o=new n7(l.fieldMask),a=l.fieldTransforms;else if(s.mergeFields){let e=[];for(let r of s.mergeFields){let i=function(e,t,n){if((t=eq(t))instanceof a2)return t._internalPath;if("string"==typeof t)return la(e,t);throw ll("Field path arguments must be of type string or ",e,!1,void 0,n)}(t,r,n);if(!l.contains(i))throw new nS(nC.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);(function(e,t){return e.some(e=>e.isEqual(t))})(e,i)||e.push(i)}o=new n7(e),a=l.fieldTransforms.filter(e=>o.covers(e.field))}else o=null,a=l.fieldTransforms;return new a4(new rM(u),o,a)})(lt(e.firestore),"addDoc",i._key,s,null!==e.converter,{}).toMutation(i._key,iD.exists(!1))]).then(()=>i)}(aQ(r,"books"),{title:e,author:t,genre:n,rating:s,email:i.email}),console.log(`Book "${e}" added successfully by ${i.email}.`),l()}catch(e){console.error("Error adding book:",e)}})}async function l(){console.log("Fetching books..."),i.onAuthStateChanged(async t=>{if(!t){console.log("No user signed in. Cannot fetch books.");return}try{let n=function(e,t,...n){let r=[];for(let i of(t instanceof lf&&r.push(t),function(e){let t=e.filter(e=>e instanceof lg).length,n=e.filter(e=>e instanceof lp).length;if(t>1||t>0&&n>0)throw new nS(nC.INVALID_ARGUMENT,"InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.")}(r=r.concat(n)),r))e=i._apply(e);return e}(aQ(r,"books"),function(e,t,n){let r=lc("where",e);return lp._create(r,"==",n)}("email",0,t.email)),i=await function(e){e=a$(e,aK);let t=a$(e.firestore,aZ),n=a0(t),r=new lT(t);return(/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
